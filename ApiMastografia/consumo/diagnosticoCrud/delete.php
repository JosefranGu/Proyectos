...
// URL de la API
$url = 'http://localhost:8080/ApiMastografia/diagnostico/delete.php';
...
$opciones = [
    "http" => [
        ...
        "content" => json_encode(["id_diagnostico" => $id_diagnostico]) // Adjust the key to match the expected variable name in delete.php
    ]
];
