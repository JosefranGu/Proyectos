...
// URL de la API
$url = 'http://localhost:8080/ApiMastografia/medico/delete.php';
...
$opciones = [
    "http" => [
        ...
        "content" => json_encode(["id_med" => $id_med]) // Adjust the key to match the expected variable name in delete.php
    ]
];
