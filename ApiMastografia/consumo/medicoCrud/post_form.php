...
<body>
  ...
  <h1 class="text-center">Registro de Medico</h1>
        ...
        <div class="col-md-6">
            <form method="post" action="post.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="consultorio" name="consultorio" placeholder="Ingresa el consultorio" required>
                </div>
                <div class="d-grid">
