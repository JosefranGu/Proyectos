...
if (
    ...
    if ($medico->create()) {
        ...
        echo json_encode(array("message" => "Medico creado"));
    } else {
        http_response_code(503);
        echo json_encode(array("message" => "No se puede crear el medico"));
    }
} else {
    http_response_code(400);
    echo json_encode(array("message" => "No se puede crear el medico. Informacion incompleta."));
}
