...
<div class="container mt-7">
    <div class="justify-content-center">
        ...
        ?>
        <div align="center">
            <a align="left" class="btn btn-secondary" href="listarBaño.php" role="button">Visualizar Datos </a>
        ...
        <div class="col-md-text-center">
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrarBaño.php">
                    <div class="mb-3">
                        <label class="form-label">Recibo: </label>
                        <input type="number" class="form-control" name="txtRecibo" autofocus required>
                    </div>
                    <div class="mb-3">
