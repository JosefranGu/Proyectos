...
$sentencia = $bd->query("select * from campo order by Recibo");
...
<div>
    <h2 class="text-center">Listado de Paquete de Campo</h2>
</div>
<br>
<div align="center">
    <a align="left" class="btn btn-secondary" href="registroCampo.php" role="button">Añadir Nuevo Registro </a>
    ...
    <tbody>
        ...
        <?php foreach ($producto as $dato) { ?>
            <tr>
                ...
                <td><a class="text-success" href="editarCampo.php?Recibo=<?php echo $dato->Recibo; ?>"><i class="bi bi-pencil-square"></i></a></td>
                <td><a onclick="return confirm('Estas seguro de eliminar?');" class="text-danger" href="eliminarCampo.php?Recibo=<?php echo $dato->Recibo; ?>"><i class="bi bi-trash"></i></a></td>
