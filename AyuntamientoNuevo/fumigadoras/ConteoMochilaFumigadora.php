...
$sentencia = $bd->query("CALL obtenerCantidadArticulosNoEntregadosFumigadoraMochila();");
...
<div>
    <h2 class="text-center">Conteo de Mochila Fumigadora</h2>
</div>
<br>
<div align="center">
...
<table class="table table-light table-bordered">
    <tbody>
        <tr>
            <th width="8%" class="text-center">Numero de Mochila Fumigadora</th>
        </tr>
