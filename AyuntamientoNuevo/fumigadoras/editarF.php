...
$sentencia = $bd->prepare("select * from fumigadoras where Recibo = ?;");
...
<div class="container mt-7">
    <div class="justify-content-center">
        ...
        ?>
        <div align="center">
            <a align="left" class="btn btn-secondary" href="listarF.php" role="button">Visualizar Datos </a>
        ...
        <div class="col-md-text-center">
            <div class="card">
                ...
                <form class="p-4" method="POST" action="editarProcesoF.php">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-select" name="txtDescripcion" autofocus required value="<?php echo $producto->Articulo; ?>">
                            <option>Mochila Fumigadora</option>
                            <option>Bomba Fumigadora Motorizada</option>
                        </select>
                    </div>
                    <div class="mb-3">
