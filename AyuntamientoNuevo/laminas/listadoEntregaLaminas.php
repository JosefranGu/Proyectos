...
$sentencia = $bd->query("SELECT Recibo, NombreCompleto, Telefono, Adicional, NumArticulos, Articulo, Entregado, Nota FROM laminas WHERE Entregado='NO ENTREGADO' ORDER BY Recibo;");
$producto = $sentencia->fetchAll(PDO::FETCH_OBJ);
//print_r($persona);
?>
<div>
    <h2 class="text-center">Listado de Laminas Entregas</h2>
</div>
<br>
<div align="center">
