...
$sentencia = $bd->query("select * from laminas order by Recibo");
...
<div>
    <h2 class="text-center">Listado Laminas</h2>
</div>
<br>
<div align="center">
    ...
    <tbody>
        ...
        <?php foreach ($producto as $dato) { ?>
            <tr>
                ...
                <td><a class="text-success" href="editarLamina.php?Recibo=<?php echo $dato->Recibo; ?>"><i class="bi bi-pencil-square"></i></a></td>
                <td><a onclick="return confirm('Estas seguro de eliminar?');" class="text-danger" href="eliminarLamina.php?Recibo=<?php echo $dato->Recibo; ?>"><i class="bi bi-trash"></i></a></td>
