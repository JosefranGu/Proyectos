...
$sentencia = $bd->query("select * from paquetes order by Recibo");
...
<div>
    <h2 class="text-center">Lista de clientes y productos</h2>
</div>
<br>
<div align="center">
    <a align="left" class="btn btn-secondary" href="Registro.php" role="button">Añadir Nuevo Registro </a>
    ...
    <tbody>
        ...
        <?php foreach ($producto as $dato) { ?>
            <tr>
                ...
                <td><a class="text-success" href="editar.php?Recibo=<?php echo $dato->Recibo; ?>"><i class="bi bi-pencil-square"></i></a></td>
                <td><a onclick="return confirm('Estas seguro de eliminar?');" class="text-danger" href="eliminar.php?Recibo=<?php echo $dato->Recibo; ?>"><i class="bi bi-trash"></i></a></td>
