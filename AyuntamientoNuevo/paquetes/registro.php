...
<div class="container mt-7">
    <div class="justify-content-center">
        ...
        ?>
        <div align="center">
            <a align="left" class="btn btn-secondary" href="listar.php" role="button">Visualizar Datos </a>
                   ...
                   <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-select" name="txtDescripcion" autofocus required>
                            <option>Paquete de 12 </option>
                            <option>Paquete de 15 </option>
                            <option>Paquete de 20 </option>
                        </select>
                    </div>
                    <div class="mb-3">
