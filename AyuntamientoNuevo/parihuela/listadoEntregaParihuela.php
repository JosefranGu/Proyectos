...
$sentencia = $bd->query("SELECT Recibo, NombreCompleto, Telefono, Adicional, NumArticulos, Articulo, Entregado, Nota FROM parihuela WHERE Entregado='NO ENTREGADO' ORDER BY Recibo;");
$producto = $sentencia->fetchAll(PDO::FETCH_OBJ);
//print_r($persona);
?>
<div>
    <h2 class="text-center">Listado de Parihuela Entregas</h2>
</div>
<br>
<div align="center">
