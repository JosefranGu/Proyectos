...
$sentencia = $bd->prepare("select * from vivienda where Recibo = ?;");
...
<div class="container mt-7">
    <div class="justify-content-center">
        ...
        ?>
        <div align="center">
            <a align="left" class="btn btn-secondary" href="listarVivienda.php" role="button">Visualizar Datos </a>
        ...
        <div class="col-md-text-center">
            <div class="card">
                ...
                <form class="p-4" method="POST" action="editarProcesoVivienda.php">
                    <div class="mb-3">
